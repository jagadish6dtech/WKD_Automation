...
ONBOARDING_EKYC_TEST
    ...
    Create Session    onboard  https://wakanda.apigw.10.0.14.241.nip.io  disable_warnings=1  verify=False
    ${header}=    create dictionary    x-trace-id=123${kyc_ref}    username='eKYC'    channel='eKYC'
...
...  }
    ...
    ${response}=    POST On Session    onboard    /order-service/orders/onboarding    json=${json_string}    headers=${header}  verify=${false}
